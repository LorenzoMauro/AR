                ...
                for Net in Networks:
                    ...
                    with tf.name_scope(Net):
                        ...
                        with tf.name_scope("Now_Loss"):
                            ...
                            now_loss = tf.reduce_sum(tf.matmul(self.now_weight[z,...], cross_entropy_Now_vec, transpose_b=True))
                        ...
                        with tf.name_scope("help_Loss"):
                            ...
                            help_loss = tf.reduce_sum(tf.matmul(self.help_weight[z,...], cross_entropy_help_vec, transpose_b=True))
