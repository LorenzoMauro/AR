...
from network_2 import activity_network
from network_2 import Training
from network_2 import Input_manager
import config
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        while step < config.tot_steps:
            ...
            for batch in ready_batch:
                summary, t_op, y_Lstm, y_c3d, c_state, h_state, multi, forecast, y_Next = sess.run([Train_Net.merged, Train_Net.train_op,
                                                                                                   Train_Net.predictions_Lstm_list, Train_Net.predictions_c3d_list,
                                                                                                   Train_Net.c_out_list, Train_Net.h_out_list,
                                                                                                   Train_Net.multi_sigmoid_list, Train_Net.forecast_softmax_list,
                ...
                if step % 1000 == 0 or (step + 1) == config.tot_steps:
                    ...
                    if validation:
                        ...
                        for batch in val_batch:
                            ...
                            summary, y_Lstm, y_c3d, c_state, h_state, multi, forecast, y_Next = sess.run([Train_Net.merged,
                                                                                                               Train_Net.predictions_Lstm_list, Train_Net.predictions_c3d_list,
                                                                                                               Train_Net.c_out_list, Train_Net.h_out_list,
                                                                                                               Train_Net.multi_sigmoid_list, Train_Net.forecast_softmax_list,
                                                                                                               Train_Net.predictions_Lstm_next_list],
